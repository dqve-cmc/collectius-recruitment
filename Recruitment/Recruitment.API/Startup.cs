    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                ...
                {
                    manager.FeatureProviders.Add(new CommandControllerFeatureProvider(typeof(CalculateHashCommand).Assembly));
                });

            services.AddCommands(typeof(CalculateHashCommandHandler).Assembly, typeof(CalculateHashCommand).Assembly);
